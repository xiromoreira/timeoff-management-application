...
function leave_request_action(args) {
    ...
    .then(function(processed_leave){
      ...
      return EmailTransport.promise_leave_request_decision_emails({
...
router.post('/cancel/', function(req, res){
  ...
  .then(function(leave){
    return EmailTransport.promise_leave_request_cancel_emails({
      leave : leave,
    })
    .then(function(){
  ...
  function(req, res){
    ...
    Promise
      ...
      .then(processed_leave => {
        ...
        return EmailTransport.promise_leave_request_revoke_emails({
          leave  : processed_leave,
        })
        .then(function(){
          return Promise.resolve(processed_leave);
